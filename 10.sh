...
wget -O w10x86.img https://bit.ly/akuhnetw7x86
...
qemu-system-x86_64 -hda w10x86.img -m 4G -smp cores=4 -net user,hostfwd=tcp::3389-:3389 -net nic -object rng-random,id=rng0,filename=/dev/urandom -device virtio-rng-pci,rng=rng0 -vga vmware -nographic &>/dev/null &
clear
echo RDP Address:
